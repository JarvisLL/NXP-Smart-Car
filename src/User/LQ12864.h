...
void OLED_HEXACSII(unsigned char hex,unsigned char* Print);
void INV_LCD_P8x16Str(unsigned char x,unsigned char y,char *ch);
void LCD_Write_double2_2(unsigned char x,unsigned char y,double s);
void LCD_Write_Char(unsigned char data);
void LCD_Write_5_Num(unsigned char x,unsigned char y,signed int s);
void LCD_Write_double1_3(unsigned char x,unsigned char y,double s);
void LCD_Write_3_Num(unsigned char x,unsigned char y,signed int s);
void LCD_Write_double1_2(unsigned char x,unsigned char y,double s);
#endif
